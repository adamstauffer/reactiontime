...
class User(CRUDMixin, UserMixin, db.Model):
    ...
    best_time = db.Column(db.Float(default=None))
    ...
    def get_active_users(cls):
        """Method to return all active users.

        Returns:
            A query object consisting of all active users.
        """
        return cls.query.filter(cls.active, cls.id != current_user.id)
